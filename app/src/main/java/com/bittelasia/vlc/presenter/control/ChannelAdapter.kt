package com.bittelasia.vlc.presenter.control
...
class ChannelAdapter(private val callback: (Int) -> Unit) : ListAdapter<VideoInfo, ChannelAdapter.ViewHolder>(ChannelComparator()) {
